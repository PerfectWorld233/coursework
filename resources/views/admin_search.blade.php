    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3" >
        <div class="card-header">
          <i class="fa fa-file"></i> Admin Search</div>
        <div class="card-body">

        <form action="<?php echo url('/'); ?>/search_admin" method="post">
           <input type="hidden" id="token" name="_token" value="<?php echo csrf_token(); ?>" >
            <div class="table-responsive">
                <div class="form-row">
                    ...
                    <div class="col-md-6">
                      <select name="field" aria-controls="dataTable" class="form-control form-control-sm">
